...
net = caffe.Net('/nfs/hn46/xiaolonw/render_cnncode/caffe-rgbd/render_scripts/pre_cls_1fc_scratch/test.prototxt',
                '/nfs.yoda/xiaolonw/fast_rcnn/models_sunrgbd/pre_cls_1fc_scratch/model__iter_20000.caffemodel',
                caffe.TEST)
